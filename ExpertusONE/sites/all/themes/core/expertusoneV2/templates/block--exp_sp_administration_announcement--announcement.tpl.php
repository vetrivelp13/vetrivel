 ...
 */
 global $user;
?>
<li id="announcement" class="sortable-item">
<div id="<?php print $block_html_id; ?>" class="<?php print $classes; ?>">
  <div id='div_announcement' class="most-active-user" style='width:100%'>
    <div class='block-title-left'>
 	  <div class='block-title-right'>
 	    <div class='block-title-middle'>
 		  <?php if ($title): ?>
 		    <h2 class='block-title'><?php print $title; ?>
 		    <div class="delete-widget flt_right"><a href='javascript:void(0);' onclick='$("body").data("learningcore").displayDeleteWizardLearner("<?php print t("MSG703").' <span class=\"del_panel\">'.strtoupper($title).'</span> '. strtolower(t('Panel'));?>", "announcement", "sidebar_second-list")' class='widget-delete-button'>X</a></div>
 		    </h2>
 		  <?php endif; ?>
 		</div>
 	  </div>
