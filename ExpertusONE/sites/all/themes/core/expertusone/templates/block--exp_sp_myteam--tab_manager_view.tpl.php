					...
					<div class="find-trng-sort" id='find-trng-sort-display' style="display:none;">						
                        <div class="find-trng-sortby">
                        	...
                        	<ul class="sort-by-links">
                            	<li class="first"><a class='type1' onclick='$("#lnr-myteam-search").data("lnrmyteamsearch").searchAction("AZ","type1");'><?php print t("LBL017"); ?><span class="enroll-pipeline">|</span></a></li>
                            	<li><a class='type2' onclick='$("#lnr-myteam-search").data("lnrmyteamsearch").searchAction("ZA","type2");'><?php print t("LBL018"); ?><span class="enroll-pipeline">|</span></a></li>
                            	<li><a class='type3' onclick='$("#lnr-myteam-search").data("lnrmyteamsearch").searchAction("Time","type3");'><?php print t("LBL044"); ?></a></li>
 							</ul>
