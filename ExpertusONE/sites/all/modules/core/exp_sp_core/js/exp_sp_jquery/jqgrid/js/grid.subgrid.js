...
addSubGrid : function(t,row,pos,rowelem) { 
	return this.each(function(){
		...
		$(td,t).html("<div class='ui-icon-plus'></div>").addClass("sgcollapsed")
		.click( function(e) {
			if($(this).hasClass("sgcollapsed")) {
				...
				$(this).html("<div class='ui-icon-minus'></div>").removeClass("sgcollapsed").addClass("sgexpanded");
				...
				$(this).html("<div class='ui-icon-plus'></div>").removeClass("sgexpanded").addClass("sgcollapsed");
			}
			return false;
			});
		row.appendChild(td);
