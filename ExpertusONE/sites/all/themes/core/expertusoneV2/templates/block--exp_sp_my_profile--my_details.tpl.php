...
<div id="<?php print $block_html_id; ?>" class="<?php print $classes; ?>">
  <div id='learner-myprofile-details'>
   	<div class='block-title-left'>
  	  ...
  	  <div class="content">	    
  	   ...
  	   <div id="wizard-form-wrapper" class="my-profile-wrapper">
  	      <?php print $content; ?>
  	   </div>
        </div>	    
  	  </div>
...
<?php  drupal_add_js('jQuery(document).ready(function () { $("#userprofile-part .limit-title").trunk8(trunk8.profile_title);$("#userprofile-part .limit-desc").trunk8(trunk8.profile_desc); });', 'inline'); ?>