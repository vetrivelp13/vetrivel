...
<?php print $head; ?>
  <?php print $styles; ?>
  <?php print $scripts; ?>
<div id="page-container" style="height:650px;">
<div id="page-wrapper" <?php print $page_class;?>><div id="page">

  <div id="header" style='height:99px;'><div class="section clearfix">
    <?php if ($logo): ?>
...
<!--  
		<div class="footer-container">
			<div class="footer-phone-info"><?php print t('LBL070') ?>: <?php print getConfigValue('site_phone'); ?></div>
  			<div class="footer-email-info"><?php print t('LBL061') ?>: <?php print variable_get('site_mail'); ?></div>
