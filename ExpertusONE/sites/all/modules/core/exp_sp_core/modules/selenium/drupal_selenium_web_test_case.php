...
//DrupalWebTestCase
//ExpertusWebTestCase
class DrupalSeleniumWebTestCase extends  ExpertusWebTestCase{
  ...
  protected function drupalLogin($user) {
    ...
    $pass = $this->assertTextHelper(t('WELCOME'), t('User %name successfully logged in.', array('%name' => $user->name)), t('User login'));
