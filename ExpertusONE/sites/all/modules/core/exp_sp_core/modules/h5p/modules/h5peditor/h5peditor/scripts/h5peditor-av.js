...
H5PEditor.widgets.video = H5PEditor.widgets.audio = H5PEditor.AV = (function ($) {
  ...
  C.prototype.appendTo = function ($wrapper) {
    ...
    window.setTimeout(function(){
		...
		var htm ='<div class="addedit-new-field-title" style="width: 90px;font-family: ProximaNovaBold, Arial;padding: 6px 5px 2px 0;font-size: 12px;color: #474747;margin-bottom: -17px;">'+window.parent.Drupal.t("Video")+':</div>';
