...
var DEFAULT_URL = 'compressed.tracemonkey-pldi-09111.pdf';
...
function getURLParameter(name, urlsearch) {
		...
		return decodeURIComponent((new RegExp('[?|&]' + name + '=' + '([^&;]+?)(&|#|;|$)').exec(urlsearch||location.search) || [ , "" ])[1]
				.replace(/\+/g, '%20'))
				|| null;
	}
...
var PDFPageView = (function PDFPageViewClosure() {
  ...
  //alert(getURLParameter('current_page', abc));
  
  var get_page = getURLParameter('current_page', abc)
  
    setTimeout(function(){
     PDFViewerApplication.page = get_page;
     }, 3000);
