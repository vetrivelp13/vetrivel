    ...
    <div id='catalogSearchOptDiv'>
      ...
      <input type="hidden" value="profiles" id="eol-search-value" name="domain">
        <ul class="eol-search eol-search-profiles" id="objectTypeSearch">
          <li class='eol-search-input'><span><input value='<?php print t('LBL304');?>' type='text' onblur="if(this.value=='') {this.value='<?php print t('LBL304');?>';this.style.color='#999999';this.style.fontSize='13px';} if(this.value != '<?php print t('LBL304');?>') { this.style.color='#333333';this.style.fontSize='13px';}" onfocus="if(this.value=='<?php print t('LBL304');?>') this.value=''; this.style.color='#333333'; this.style.fontSize='13px';" name='searchword' class='ac_input searchtext' ondrop="return false;" size='25' maxlength='70' id='myteam_searchtext' alt='search...' size='20' autocomplete='on' /></span>
         <!-- <div class="eol-search-clearance"><span id="searchclear" ></span></div>-->
          </li>
          <li class='eol-search-go'><a id='myteam-search-txt' href='javascript:void(0);' >&nbsp;</a></li>
        </ul>
      </div>
      </div>
  </div>
