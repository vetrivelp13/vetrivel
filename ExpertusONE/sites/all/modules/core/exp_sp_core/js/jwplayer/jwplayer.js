if (typeof jwplayer == "undefined") {
  ...
  (function(b) {
          ...
          if (e.status === 200) {
            if (f) {
              if (!b.utils.exists(e.responseXML)) {
                try {
                  if (window.DOMParser) {
                    var h = (new DOMParser()).parseFromString(e.responseText,
                        "text/xml");
                    if (h) {
                      e = b.utils.extend( {}, e, {
                        responseXML : h
    ...
    b.utils.timeFormat = function(c) {
      str = "00:00";
      if (c > 0) {
        str = Math.floor(c / 60) < 10 ? "0" + Math.floor(c / 60) + ":" : Math
            .floor(c / 60)
            + ":";
        str += Math.floor(c % 60) < 10 ? "0" + Math.floor(c % 60) : Math
            .floor(c % 60)
      ...
      if (e == b.api.events.JWPLAYER_FULLSCREEN && !g.fullscreen) {
        ...
        if (typeof g.data == "object") {
          ...
          if (typeof g.metadata == "object") {
            b.utils.deepReplaceKeyName(g.metadata, [ "__dot__", "__spc__",
                "__dsh__" ], [ ".", " ", "-" ])
          }
        }
      }
      ...
      this.removeGlobalListener = function(listener) {
        ...
        try {
          for ( var globalListenerIndex = 0; globalListenerIndex < _globallisteners.length; globalListenerIndex++) {
            if (_globallisteners[globalListenerIndex].listener.toString() == listener
                .toString()) {
      ...
      this.sendEvent = function(type, data) {
        ...
        for ( var globalListenerIndex = 0; globalListenerIndex < _globallisteners.length; globalListenerIndex++) {
          try {
            ...
            jwplayer.utils.log("There was an error while handling a listener: "
                + err.toString(),
    ...
    a.utils.strings.xmlAttribute = function(b, c) {
      for ( var d = 0; d < b.attributes.length; d++) {
        if (b.attributes[d].name
            && b.attributes[d].name.toLowerCase() == c.toLowerCase()) {
      ...
      for ( var b = 0; b < c.childNodes.length; b++) {
        if (c.childNodes[b].prefix == a.utils.parsers.jwparser.PREFIX) {
          d[a.utils.parsers.localName(c.childNodes[b])] = a.utils.strings
              .serialize(a.utils.parsers.textContent(c.childNodes[b]));
        ...
        if (d.childNodes[c].prefix == a.utils.parsers.mediaparser.PREFIX) {
          ...
          case "content":
            ...
            if (a.utils.strings.xmlAttribute(d.childNodes[c], "duration")) {
              f.duration = a.utils.strings.seconds(a.utils.strings
                  .xmlAttribute(d.childNodes[c], "duration"))
            }
            if (a.utils.strings.xmlAttribute(d.childNodes[c], "start")) {
              f.start = a.utils.strings.seconds(a.utils.strings.xmlAttribute(
                  d.childNodes[c], "start"))
            }
            ...
            if (a.utils.strings.xmlAttribute(d.childNodes[c], "width")
              ...
              f.levels.push( {
                ...
                bitrate : a.utils.strings.xmlAttribute(d.childNodes[c],
                    "bitrate"),
      ...
      for ( var e = 0; e < f.childNodes.length; e++) {
        if (b.utils.parsers.localName(f.childNodes[e]).toLowerCase() == "channel") {
          for ( var d = 0; d < f.childNodes[e].childNodes.length; d++) {
            if (b.utils.parsers.localName(f.childNodes[e].childNodes[d])
                .toLowerCase() == "item") {
    ...
    a.plugins.plugin = function(b) {
      ...
      function e() {
        ...
        case a.utils.pluginPathType.CDN:
          ...
          var m = (window.location.href.indexOf("https://") == 0) ? d.replace(
              "http://", "https://secure") : d;
          return m + "/" + a.version.split(".")[0] + "/" + o + "/" + o
              + (n !== "" ? ("-" + n) : "") + ".js"
        }
      }
      function g(m) {
  ...
  (function(b) {
    ...
    b.api = function(d) {
      ...
      this.getPlugin = function(u) {
        ...
        if (u == "dock") {
          return b.utils.extend(v, {
            ...
            onShow : function(x) {
              w.componentListener("dock", b.api.events.JWPLAYER_COMPONENT_SHOW,
                  x);
              return v
            },
            onHide : function(x) {
              w.componentListener("dock", b.api.events.JWPLAYER_COMPONENT_HIDE,
                  x);
              return v
            }
          })
          ...
          if (u == "controlbar") {
            return b.utils.extend(v, {
              ...
              onShow : function(x) {
                w.componentListener("controlbar",
      ...
      this.onBeforeComplete = function(u) {
        return this
            .eventListener(b.api.events.JWPLAYER_MEDIA_BEFORECOMPLETE, u)
      };
      ...
      this.addInternalListener = function(u, v) {
        try {
          u.jwAddEventListener(v, 'function(dat) { jwplayer("' + this.id
              + '").dispatchEvent("' + v + '", dat); }')
        } catch (w) {
  ...
  (function(a) {
    a.api.instream = function(c, j, n, q) {
      ...
      function m(r, s) {
        b.jwInstreamAddEventListener(s, 'function(dat) { jwplayer("' + h.id
            + '").dispatchInstreamEvent("' + s + '", dat); }')
      }
      function d(r, s) {
        if (!e[r]) {
          e[r] = [];
  ...
  (function(e) {
    ...
    function h(m) {
      var l = [ {
        type : "flash",
        src : m ? m : "/sites/all/modules/core/exp_sp_core/js/jwplayer/player.swf"
      }, {
        type : "html5"
      }, {
        type : "download"
  ...
  (function(a) {
    a.embed.download = function(c, g, b, d, f) {
      this.embed = function() {
        ...
        function t() {
          a.utils.stretch(a.utils.stretching.UNIFORM, q.display_image, j, m,
        ...
        q.display.appendChild(new a.embed.logo(b.components.logo, "download",
            c.id));
            ...
            if (j.file) {
              ...
              if (j.levels && j.levels.length) {
                for ( var h = 0; h < j.levels.length; h++) {
                  if (j.levels[h].file
                      && e(j.levels[h].file, j.provider, j.playlistfile)) {
                    return true
                  }
                }
              }
  ...
  (function(a) {
    a.embed.flash = function(f, g, l, e, j) {
      ...
      function c(p) {
        var n = p.netstreambasepath ? "" : "netstreambasepath="
              ...
              if (o.file) {
                ...
                if (o.levels && o.levels.length) {
                  for ( var n = 0; n < o.levels.length; n++) {
                    if (o.levels[n].file
                        && flashCanPlay(o.levels[n].file, o.provider)) {
                      return true
                    }
                  }
                }
            ...
            if (typeof j.file == "undefined" && typeof j.levels == "undefined") {
              ...
              if (j.file) {
                ...
                if (j.levels && j.levels.length) {
                  for ( var h = 0; h < j.levels.length; h++) {
                    if (j.levels[h].file
                        && html5CanPlay(a.vid, j.levels[h].file, j.provider,
                            j.playlistfile)) {
                      return true
                    }
                  }
    ...
    a.html5.view = function(l, D, g) {
      ...
      function G() {
        for ( var P = 0; P < h.plugins.order.length; P++) {
          ...
          if (c.exists(h.plugins.object[Q].getDisplayElement)) {
            h.plugins.object[Q].height = c.parseDimension(h.plugins.object[Q]
                .getDisplayElement().style.height);
            h.plugins.object[Q].width = c.parseDimension(h.plugins.object[Q]
      ...
      var j = this.resizeMedia = function() {
        ...
        if (R && R.tagName.toLowerCase() == "video") {
          ...
          if (h.fullscreen
            ...
            c.stretch(a.utils.stretching.UNIFORM, P, c.getElementWidth(m), c
                .getElementHeight(m), x, J);
            c.stretch(a.utils.stretching.EXACTFIT, R, c
                .parseDimension(P.style.width), c
                .parseDimension(P.style.height), R.videoWidth ? R.videoWidth
                : 400, R.videoHeight ? R.videoHeight : 300);
            b(R, {
              left : P.style.left,
              top : P.style.top
            })
          } else {
            c.stretch(k.jwGetStretching(), R, c.getElementWidth(m), c
                .getElementHeight(m), R.videoWidth ? R.videoWidth : 400,
      ...
      var w = this.getComponentPosition = function(Q) {
        ...
        case a.html5.view.positions.TOP:
          ...
          R.width = c.getElementWidth(m) - c.parseDimension(m.style.left)
        ...
        case a.html5.view.positions.RIGHT:
          ...
          R.height = c.getElementHeight(m) - c.parseDimension(m.style.top)
        ...
        case a.html5.view.positions.LEFT:
          ...
          R.height = c.getElementHeight(m) - c.parseDimension(m.style.top)
              - c.parseDimension(m.style.bottom);
          m.style[P] = c.parseDimension(m.style[P]) + h.plugins.object[Q].width
              + "px";
          m.style.width = c.getElementWidth(m) - R.width + "px";
          break;
        default:
      ...
      function O(P) {
        return ( [ a.html5.view.positions.TOP, a.html5.view.positions.RIGHT,
            a.html5.view.positions.BOTTOM, a.html5.view.positions.LEFT ]
            .toString().indexOf(P.toUpperCase()) > -1)
      }
      function y() {
        if (k.jwGetState() != a.api.events.state.IDLE
            && !A
  ...
  (function(a) {
    ...
    a.html5.controlbar = function(m, X) {
      ...
      var l = m;
      var D = _utils.extend( {}, b, l.skin.getComponentSettings("controlbar"),
          X);
      ...
      function C(aq, at, av) {
        ...
        case "next":
          ...
          break;
        case "elapsed":
          y("elapsedText", at, true, av, null, null, l.skin.getSkinElement(
              "controlbar", "elapsedBackground"));
          break;
        case "time":
          an = !_utils.exists(l.skin.getSkinElement("controlbar",
              "timeSliderCapLeft")) ? 0 : l.skin.getSkinElement("controlbar",
              "timeSliderCapLeft").width;
          ao = !_utils.exists(l.skin.getSkinElement("controlbar",
              "timeSliderCapRight")) ? 0 : l.skin.getSkinElement("controlbar",
              "timeSliderCapRight").width;
          ap = at == "left" ? an : ao;
          aw = {
            height : K().height,
            position : "relative",
        ...
        case "volume":
          an = !_utils.exists(l.skin.getSkinElement("controlbar",
              "volumeSliderCapLeft")) ? 0 : l.skin.getSkinElement("controlbar",
              "volumeSliderCapLeft").width;
          ao = !_utils.exists(l.skin.getSkinElement("controlbar",
              "volumeSliderCapRight")) ? 0 : l.skin.getSkinElement(
              "controlbar", "volumeSliderCapRight").width;
          ap = at == "left" ? an : ao;
          am = l.skin.getSkinElement("controlbar", "volumeSliderRail").width
              + an + ao;
          aw = {
            height : K().height,
            position : "relative",
        ...
        case "mute":
          ...
          break;
        case "duration":
          y("durationText", at, true, av, null, null, l.skin.getSkinElement(
              "controlbar", "durationBackground"));
          break
        }
      }
      function y(ap, at, an, aw, aq, am, ao) {
        if (_utils.exists(l.skin.getSkinElement("controlbar", ap))
            || ap.indexOf("Text") > 0 || ap.indexOf("divider") === 0) {
          var ar = {
            height : "100%",
            ...
            if (_utils.exists(l.skin.getSkinElement("controlbar", ap + "Over"))) {
              av.onmouseover = function(ay) {
                av.style.backgroundImage = [ "url(",
                    l.skin.getSkinElement("controlbar", ap + "Over").src, ")" ]
                    .join("")
              };
              av.onmouseout = function(ay) {
                av.style.backgroundImage = [ "url(",
                    l.skin.getSkinElement("controlbar", ap).src, ")" ].join("")
              }
            }
            if (ap.indexOf("divider") == 0) {
      ...
      function v(an) {
        ...
        if (c.timeSliderRail) {
          ...
          var am = isNaN(Math.round(ao * g / 100)) ? 0 : Math.round(ao * g
              / 100);
      ...
      function J(aq) {
        ...
        if (at) {
          var an = isNaN(Math.round(at.width * ao)) ? 0 : Math.round(at.width
              * ao);
      ...
      function n(ar) {
        if (_utils.exists(R.volumeSliderRail)) {
          ...
          var an = (!_utils.exists(l.skin.getSkinElement("controlbar",
              "volumeSliderCapLeft"))) ? 0 : l.skin.getSkinElement(
              "controlbar", "volumeSliderCapLeft").width;
          _css(R.volumeSliderProgress, {
            width : am,
            left : an
          });
          if (R.volumeSliderThumb) {
            var aq = (am - Math.round(_utils
                .parseDimension(R.volumeSliderThumb.style.width) / 2));
            aq = Math.min(Math.max(aq, 0), ap
                - _utils.parseDimension(R.volumeSliderThumb.style.width));
      ...
      function S() {
        try {
          var an = (l.id.indexOf("_instream") > 0 ? l.id.replace("_instream",
              "") : l.id);
  ...
  (function(b) {
    ...
    b.html5.controller = function(o, K, f, h) {
      ...
      var D = (c.exists(m.config.debug) && (m.config.debug.toString()
          .toLowerCase() == "console")), N = new b.html5.eventdispatcher(y.id,
          D);
      c.extend(this, N);
      function L(T) {
        if (q) {
    ...
    a.html5.display = function(k, K) {
      ...
      function c() {
        if (h.jwGetFullscreen()
          ...
          _utils.stretch(a.utils.stretching.EXACTFIT, W.display_image, _utils
      ...
      function U(Y) {
        ...
        W.display_icon.style.backgroundImage = ( [ "url(",
            h.skin.getSkinElement("display", Y).src, ")" ]).join("");
        _css(W.display_icon, {
          ...
          if (H) {
            ...
            if (!j[K].div) {
              ...
              if (w.skin.getSkinElement("dock", "button")) {
                j[K].div.childNodes[1].src = w.skin.getSkinElement("dock",
                    "button").src
              }
      ...
      function l(H, T) {
        ...
        if (A.length > 0) {
          ...
          for ( var J = 0; J < A.length; J++) {
            ...
            var K = j[A[J]].div;
            K.style.top = (S % T) + "px";
            K.style.left = (M + (w.skin.getSkinElement("dock", "button").width + I)
                * U * P)
                + "px";
            var N = {
  ...
  (function(a) {
    ...
    a.html5.instream = function(y, m, x, z) {
      ...
      function s() {
        _fakemodel = new a.html5.model(this, E.getMedia() ? E.getMedia()
            .getDisplayElement() : E.container, E);
      ...
      function F() {
        if (!g) {
          g = new a.html5.mediavideo(_fakemodel, E.getMedia() ? E.getMedia()
              .getDisplayElement() : E.container);
      ...
      function o() {
        ...
        try {
          if (window.location.href.indexOf("https") == 0) {
            b.prefix = b.prefix.replace("http://l.longtailvideo.com",
  ...
  (function(jwplayer) {
    var _configurableStateVariables = [ "width", "height", "start", "duration",
        "volume", "mute", "fullscreen", "item", "plugins", "stretching" ];
    ...
    jwplayer.html5.model = function(api, container, options) {
        ...
        if (typeof _model.plugins == "string") {
          ...
          for ( var userplugin in userplugins) {
            if (typeof userplugins[userplugin] == "string") {
              pluginorder.push(userplugins[userplugin]
                  .replace(/^\s+|\s+$/g, ""))
            }
          }
        }
      ...
      for ( var pluginIndex in _model.plugins.order) {
        ...
        _model.plugins.config[pluginName] = !jwplayer.utils
            ...
            : jwplayer.utils.extend(_model.plugins.config[pluginName],
                pluginConfig);
      ...
      function _loadExternal(playlistfile) {
        ...
        loader.addEventListener(jwplayer.api.events.JWPLAYER_ERROR, function(
            evt) {
      ...
      _model.setActiveMediaProvider = function(playlistItem) {
        ...
        if (!jwplayer.utils.exists(_mediaProviders[provider])) {
          switch (provider) {
          case "video":
            _media = new jwplayer.html5.mediavideo(_model, current ? current
                : _container);
            break;
          case "youtube":
            _media = new jwplayer.html5.mediayoutube(_model, current ? current
                : _container);
            break
          }
  ...
  (function(a) {
    ...
    a.html5.playlistcomponent = function(r, C) {
      var x = r;
      var e = a.utils
          .extend( {}, c, x.skin.getComponentSettings("playlist"), C);
          ...
          if (L && L.childNodes.length > 0) {
            ...
            for ( var w = 0; w < M.length; w++) {
              ...
              for ( var v = 0; v < N.length; v++) {
                ...
                if (!a.utils
                    .exists(o[C].layout[A.getAttribute("position")].elements[v].name)) {
