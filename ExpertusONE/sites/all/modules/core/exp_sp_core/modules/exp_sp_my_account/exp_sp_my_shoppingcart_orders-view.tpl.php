...
?>
<div>
			<div id="no-order-records" style="display: none"></div>
		     <table cellspacing="2" cellpadding="2" class="my-account-box myorders" border="0" id="myaccount-orders-details">
		    </table>
		    <div id="account-pager"></div>
 </div>
