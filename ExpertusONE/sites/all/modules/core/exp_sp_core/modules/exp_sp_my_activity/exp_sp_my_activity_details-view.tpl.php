...
?>
<div> 	
   	<div id="no-acitvity-records" style="display: none"></div>
      <table cellspacing="2" cellpadding="2" class="myactivity-details" border="0" id="myprofile-activity-details">
	  </table>
    <div id="activity-pager"></div>
</div>
