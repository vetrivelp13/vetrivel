...
$testCases = array(
		...
		'UpdateAttachedQuestionsInAssessmentAPI' => array(
				'datasource' => array(
						array('input'=>array('userid'=>1,'survey_group_id'=>$grp,'group_question_id'=>$ques,'mandatoryOption'=>'Y','sequence'=>1,'survey_score'=>25),
								'output'=>array('Id'),
				...
				'validate'=>array(
						...
						array('input'=>array('userid'=>1,'survey_group_id'=>'','group_question_id'=>$ques,'mandatoryOption'=>'Y','sequence'=>1,'survey_score'=>25),
								'output'=>array(),
								'result'=>array('<error>','<error_code>','Invalid Survey Group Id','Invalid Survey Group Id'),
								'output_type'=>'xml'
						),
						array('input'=>array('userid'=>1,'survey_group_id'=>$grp,'group_question_id'=>'','mandatoryOption'=>'Y','sequence'=>1,'survey_score'=>25),
								'output'=>array(),
								'result'=>array('<error>','<error_code>','Mandatory Fields are missing in the feed','group_question_id'),
								'output_type'=>'xml'
						),
						array('input'=>array('userid'=>1,'survey_group_id'=>$grp,'group_question_id'=>$ques,'mandatoryOption'=>'','sequence'=>1,'survey_score'=>25),
								'output'=>array(),
								'result'=>array('<error>','<error_code>','Mandatory Option must be Y or N','Mandatory Option must be Y or N'),
								'output_type'=>'xml'
						),
			//Invalid data type
						array('input'=>array('userid'=>1,'survey_group_id'=>$grp,'group_question_id'=>$random_word,'mandatoryOption'=>'Y','sequence'=>1,'survey_score'=>25),
								'output'=>array(),
								'result'=>array('<error>','<error_code>','Invalid Survey Group Question Id','Invalid Survey Group Question Id'),
								'output_type'=>'xml'
						),
						array('input'=>array('userid'=>1,'survey_group_id'=>$random_word,'group_question_id'=>$ques,'mandatoryOption'=>'Y','sequence'=>1,'survey_score'=>25),
								'output'=>array(),
								'result'=>array('<error>','<error_code>','Invalid Survey Group Id','Invalid Survey Group Id'),
								'output_type'=>'xml'
						),
						array('input'=>array('userid'=>1,'survey_group_id'=>$grp,'group_question_id'=>$ques,'mandatoryOption'=>$random_word,'sequence'=>1,'survey_score'=>25),
								'output'=>array(),
								'result'=>array('<error>','<error_code>','Mandatory Option must be Y or N','Mandatory Option must be Y or N'),
								'output_type'=>'xml'
						),
