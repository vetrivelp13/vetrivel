...
<div id="<?php print $block_html_id; ?>" class="<?php print $classes; ?>">
 <?php print $block->narrow_search['disp_content']; 
 $searchCont = isset($block->narrow_search['narrow_search_content'])?$block->narrow_search['narrow_search_content']:'';
 ?>
 <span id="search_data_storage" data='<?php print $searchCont; ?>'></span>
</div>
<script language="javascript">
// $('#root-admin').data('narrowsearch').getSearchContent(< ?php print $block->narrow_search['narrow_search_content']; ?>);
</script>
