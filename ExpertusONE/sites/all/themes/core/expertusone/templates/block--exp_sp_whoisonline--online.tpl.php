    ...
    <div class='block-title-left'>
 	  <div class='block-title-right'>
 	    <div class='block-title-middle'>
 		  <?php if ($title): ?>
 		    <h2 class='block-title'><?php print t('LBL197'); ?></h2>
 		  <?php endif; ?>
 		</div>
 	  </div>
 	</div>
	<input id='exp_sp_whoisonline_block_refresh_interval' type=hidden value='<?php print variable_get('exp_sp_whoisonline_block_refresh_interval', 60); ?>' />
	<input id='exp_sp_whoisonline_block_max_list_count' type=hidden value='<?php print variable_get('exp_sp_whoisonline_block_max_list_count', 5); ?>' />
