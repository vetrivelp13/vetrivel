				...
				--><div class="region-sidebar-widget-bg"><div class="region-sidebar-widget-container">
					...
					<div class="frm-topic-list-sort" id="frm-topic-list-sort-display">						
                        <div class="frm-topic-list-sortby">
                        	<span class="frm-topic-list-sort-text"><?php print t("LBL011"); ?>:</span>
                        	<ul class="sort-by-links">
                            	<li class="first"><a class='type1' onclick='$("#forum-topic-list-display").data("forumlistdisplay").searchAction("AZ","type1","topic");'><?php print t("LBL017"); ?><span class="enroll-pipeline">|</span></a></li>
                            	<li><a class='type2' onclick='$("#forum-topic-list-display").data("forumlistdisplay").searchAction("ZA","type2","topic");'><?php print t("LBL018"); ?><span class="enroll-pipeline">|</span></a></li>
                            	<li><a class='type3' onclick='$("#forum-topic-list-display").data("forumlistdisplay").searchAction("created","type3","topic");'><?php print t("LBL044"); ?><span class="enroll-pipeline">|</span></a></li>
                            	<li><a class='type4' onclick='$("#forum-topic-list-display").data("forumlistdisplay").searchAction("posttime","type4","topic");'><?php print t("LBL873"); ?></a></li>
 							</ul>
 							<div class="clearBoth"></div>
                        </div>                        
