...
right: 0px;
z-index: 999999;
background-color: rgba(168, 165, 153, 0.6);
height: 45px;
width: 100%;
...
function pausevideo(){
	...
	//$('.content_title').fadeIn();
	//if(navigator.userAgent.match('iPhone')){
	 //window.location.href='pausevideo://expertus.com?data='+JSON.stringify(data);
	//}
}
...
//	alert(123)
seekvalue = 0;
    window.location.href='playvideo://expertus.com?data='+JSON.stringify(data);
}


function closevideo1(){
	window.location.href='changeplayerpage://expertus.com?data='+JSON.stringify(data);
}
...
//               });
        ...
        jQuery(document).ready(function() {
        	...
        	if(contentType.toLowerCase() == 'youtube'){
        		...
        		$('.youtube').attr('src',videourl+'&enablejsapi=1&showinfo=0&controls=1');
        	}
        	else{
...
<div id="player_header1">
 ...
 <div class="content_title1">
 	...
 	<span style="margin-top: -28px;font-size: 18px;color: #FFFFFF;padding-left: 25px;display: block;width: 70%;height: 20px;overflow: hidden;font-weight: bolder;
    text-shadow: 0px 0px #CCCCCC" id='content_header'></span>
 	</div>
