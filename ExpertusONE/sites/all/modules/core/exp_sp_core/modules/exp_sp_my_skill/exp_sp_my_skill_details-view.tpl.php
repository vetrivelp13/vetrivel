...
?>
<div> 	
   	<div id="no-skill-records" style="display: none"></div>
      <table cellspacing="2" cellpadding="2" class="myskill-details" border="0" id="myprofile-skill-details">
	  </table>
    <div id="skill-pager" style="display:none;"></div>
</div>
