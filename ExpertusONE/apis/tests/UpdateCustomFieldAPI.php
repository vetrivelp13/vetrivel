<?php 
$course = db_query("select entity_id as id from slt_custom_fields where entity_type = 'course'  order by id desc limit 1 ")->fetchAll();
$class = db_query("select entity_id as id from slt_custom_fields where entity_type = 'class'  order by id desc limit 1 ")->fetchAll();
$organisation = db_query("select entity_id as id from slt_custom_fields where entity_type = 'organization'  order by id desc limit 1 ")->fetchAll();
$trainingplan = db_query("select entity_id as id from slt_custom_fields where entity_type = 'cre_sys_obt_trp'  order by id desc limit 1 ")->fetchAll();
$survey = db_query("select entity_id as id from slt_custom_fields where entity_type = 'sry_det_typ_sry'  order by id desc limit 1 ")->fetchAll();
$assessment = db_query("select entity_id as id from slt_custom_fields where entity_type = 'sry_det_typ_ass'  order by id desc limit 1")->fetchAll();
$person = db_query("select entity_id as id from slt_custom_fields where entity_type = 'user'  order by id desc limit 1")->fetchAll();
$location = db_query("select entity_id as id from slt_custom_fields where entity_type = 'location'  order by id desc limit 1")->fetchAll();
$userlabel = db_query("select entity_id as id ,LOWER(label) as label  from slt_custom_fields where entity_type = 'user' order by id desc limit 1 ")->fetchAll();
...
$testCases = array(
		...
		'UpdateCustomFieldAPI' => array(
				...
				'validate' => array(
						...
						array('input'=>array('entity_type'=>'user','entity_id'=>$userlabel[0]->id,'custom_label'=>$userlabel[0]->label,'custom_value'=>$random,'userid'=>1),
								'output'=>array(''),
