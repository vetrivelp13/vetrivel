			...
			<div id="paintContent" style="width:77.3%;float:right;">
				<!-- header -->
  				<div class="block-title-left">
    				<div class="block-title-right">
      					<div class="block-title-middle">
                			<h2 class="block-title"><?php print t('TEAM');?>
                        	...
                        	<option value="Time"><?php print t("Newly Listed"); ?></option>
                        			...
                        			<ul class="sort-by-links">
                            			<li class="first"><a class='type1' onclick='$("#lnr-myteam-search").data("lnrmyteamsearch").searchAction("AZ","type1"); sortTypeToggle("sort-by-links");'><?php print t("LBL017"); ?></a></li>
                            			<li><a class='type2' onclick='$("#lnr-myteam-search").data("lnrmyteamsearch").searchAction("ZA","type2"); sortTypeToggle("sort-by-links");'><?php print t("LBL018"); ?></a></li>
                            			<li><a class='type3' onclick='$("#lnr-myteam-search").data("lnrmyteamsearch").searchAction("Time","type3"); sortTypeToggle("sort-by-links");'><?php print t("LBL044"); ?></a></li>
 									</ul>
