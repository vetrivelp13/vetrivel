		...
		function init() {
			...
			if (allTabsWidth > containerWidth) {
				...
				li = $('<li></li>')
					...
					.append($('<a href="#"></a>')
							.click(function() {
								$('#attachmentTab').click();				// To avoid hidding of active tabs done by Sadeesh
								$('#tabProfile').hide();				// To hide "Profile tab" on next tabset show - Jaikumar				
								page('next'); 
								return false; 
							})
				...
				li = $('<li></li>')
					...
					.append($('<a href="#"></a>')
							.click(function() {
								$('#tabProfile').show();					// To show "Profile tab" on previous tabset show - Jaikumar
								$('#associated_class').click(); 			// To avoid hidding of active tabs done by Sadeesh
								  page('prev'); 
								  return false; 
							  })
				...
				if (buttonPadding > 0) 
					$('.ui-tabs-paging-next', self.element).css({ paddingRight: 2 + 'px' });
