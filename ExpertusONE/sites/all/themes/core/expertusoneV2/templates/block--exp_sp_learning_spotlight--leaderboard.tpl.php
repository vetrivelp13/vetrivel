...
<div id="<?php print $block_html_id; ?>" class="<?php print $classes; ?>">
  <div id='userpoints-leaderboard' class="most-active-user" style='width:100%'>
  <div id="catalog-lb-user-list">
	...
	--><input id='exp_sp_userpoints_block_max_list_count' type=hidden value='<?php print variable_get('exp_sp_admin_userpoints_block_max_list_count', 10); ?>' />
	<div id='leader-board-loader'>
      <div id='expertus-no-user-with-points' class='lb-no-users-msg' style="display:none;">
     <?php print t('MSG672'); ?>
      </div>
      <div id='usr-leader-board-list' style="display:none;" class="leader-board-result">
        <table id ='leader-board-users-jqgrid'></table> 
