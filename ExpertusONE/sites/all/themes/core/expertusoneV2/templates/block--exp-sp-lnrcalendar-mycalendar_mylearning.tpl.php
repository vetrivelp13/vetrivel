...
<div id="<?php print $block_html_id; ?>" class="<?php print $classes; ?> mylearning-calendar-customization icon-filter" data1="calendar_custom">
 	  <div class="content">
...
expDebug::dPrint('file is called');
?>
