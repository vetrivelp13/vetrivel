				...
				<div class="region-sidebar-widget-bg">
					<div class="frm-list-sort" id='frm-list-sort-display'>						
                        <div class="frm-list-sortby">
                        	...
                        	<span class="frm-list-sort-text"><?php print t("LBL011"); ?>:</span>

                        	<ul class="sort-by-links">
                            	<li class="first"><a class='type1' onclick='$("#forum-list-display").data("forumlistdisplay").searchAction("AZ","type1","forum");'><?php print t("LBL017"); ?><span class="enroll-pipeline">|</span></a></li>
                            	<li><a class='type2' onclick='$("#forum-list-display").data("forumlistdisplay").searchAction("ZA","type2","forum");'><?php print t("LBL018"); ?><span class="enroll-pipeline">|</span></a></li>
                            	<li><a class='type3' onclick='$("#forum-list-display").data("forumlistdisplay").searchAction("created","type3","forum");'><?php print t("LBL044"); ?><span class="enroll-pipeline">|</span></a></li>
                            	<li><a class='type4' onclick='$("#forum-list-display").data("forumlistdisplay").searchAction("posttime","type4","forum");'><?php print t("LBL873"); ?></a></li>
