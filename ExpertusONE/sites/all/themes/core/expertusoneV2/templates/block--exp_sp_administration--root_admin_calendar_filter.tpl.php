 ...
 */
?>
<div id="<?php print $block_html_id; ?>" class="<?php print $classes; ?> narrow-search-calendar-filter-block">
  <?php if(drupal_get_http_header("status") != '403 Forbidden'){print $block->narrow_search_calendar_filter;} ?>
</div>
