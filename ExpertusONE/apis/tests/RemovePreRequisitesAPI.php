<?php
$id=db_query("select id from slt_common_mapping  where type=5 order by id desc limit 0,1")->fetchField();
$testCases = array(
		'RemovePreRequisitesAPI' => array(
				'datasource' => array(
				...
				'validate'=>array(
						...
						array('input'=>array('userid'=>1,'id'=>aa),
						       'output'=>array(),
							   'result'=>array('Invalid ID'),
							   'output_type'=>'xml'
							 ),
