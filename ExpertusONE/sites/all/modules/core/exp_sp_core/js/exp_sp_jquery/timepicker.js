 ...
 *
 * $Id: timepicker.js,v 1.1 2011-01-03 13:10:27 srprabhu Exp $
 *
 * Depends:
 *  ui.core.js
 *  ui.datepicker.js
...
$.datepicker._selectDate = function(id, dateStr) {
    ...
    if (inst.inline){
        ...
        if (showTime) {  // commented by Pavithra for IE issue
            //this._updateDatepicker(inst);
        } else {
    ...
    //inst.inline = true;
    //$.datepicker._hideDatepickerOverride();
    //$.timepicker.hide();
