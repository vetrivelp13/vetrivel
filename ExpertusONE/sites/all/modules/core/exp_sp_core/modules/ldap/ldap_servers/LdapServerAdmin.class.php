...
class LdapServerAdmin extends LdapServer {
  ...
  $form['#prefix'] = '<div class="block" style="margin-top:0px;"><div class="block-title-left"><div class="block-title-right block-header"><div class="block-title-middle"><h2 style="width: auto;">ADD LDAP Server</h2></div></div></div>
  ...
  $form['#suffix'] = '</div></div><div class="block-footer-left"><div class="block-footer-right"><div class="block-footer-middle">&nbsp;</div></div></div></div>';
/*  $form['#prefix'] = <<<EOF
EOF;*/  
