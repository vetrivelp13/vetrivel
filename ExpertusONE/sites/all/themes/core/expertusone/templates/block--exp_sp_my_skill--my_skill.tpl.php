   		...
   		<div class='block-title-right'>
   			<div class='block-title-middle'>
   				<?php if ($title): ?>
   				 ...
   				 <?php endif; ?>
   				 <?php if ($block->validpage=='emptyvalue'){?>
   			    <div id="skill-set-title" class="skill-set-image-button">
   				  <a href="javascript:void(0);" onclick="$('body').data('learningcore').getLeanerQtipDiv(<?php echo $data;?>,this);"><?php print t("LBL832"); ?></a>
   			</div>
   			<?php }?>
   			<div id="skill-qtipid"></div>
   		</div>
   		</div>
   	</div>
  	 <div class="content">	    
