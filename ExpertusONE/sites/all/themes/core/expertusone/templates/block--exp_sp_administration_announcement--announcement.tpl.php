...
<div id="<?php print $block_html_id; ?>" class="<?php print $classes; ?>">
  <div id='div_announcement' class="most-active-user" style='width:100%'>
	...
	<!-- <input id='exp_sp_administration_announcement_block_max_list_count' type=hidden value='<?php //print variable_get('exp_sp_administration_announcement_block_max_list_count', 5); ?>' /> -->
