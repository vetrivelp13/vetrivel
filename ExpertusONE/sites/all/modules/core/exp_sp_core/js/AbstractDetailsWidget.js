        ...
        */
        ...
        destroyDialog:function(obj,id){
         ...
         /**
           ...
           */
        createLoader:function(resultPanel){
...
//                divobj.innerHTML='<table border="0" width="100%"><tr><td width="40%" height="'+height+'px">&nbsp;</td><td align="center" height="60%" valign="middle" style="text-align:center;border:none;"><div class="loaderimg">&nbsp;</div><div><span class="ui-accordion-header">'+SMARTPORTAL.t("Loading Data")+'...</span></div></td><td width="40%" style="border:none;">&nbsp;</td></tr></table>';
	              divobj.innerHTML='<table border="0" style="width: 100%; height: 100%;"><tr><td width="40%" height="'+height+'px">&nbsp;</td><td align="center" height="100%" valign="middle"><div class="loaderimg"><span class="ui-accordion-header">'+SMARTPORTAL.t("Loading Data")+'...</span></div></td><td width="40%" height="'+height+'px">&nbsp;</td></tr></table>';
                ...
                $('#'+divid).html('<table border="0" width="100%" height="100%" style="" class=""><tr><td width="40%" style="border:none;">&nbsp;</td><td align="center" height="60%" valign="middle" style="text-align:center;border:none;"><div class="loaderimg">&nbsp;</div><div><span class="ui-accordion-header">'+SMARTPORTAL.t("Loading Data")+'...</span></div></td><td width="40%" style="border:none;">&nbsp;</td></tr></table>');
            }*/
          },
        ...
        */
                        ...
                        var name=$(this).attr('name');
                            ...
                            if(inputType=="checkbox" || inputType=="radio"){
                            	...
                            	if (inputType=="select-one") {
                            		...
                            		newDiv.id=this.id+"_newid";
                            		$("#"+this.id+"_newid").remove();
                            		$(newDiv).css({color:'red',display:'none','font-size':'0.9em','padding-left': '0px'});
        ...
        setReportFooter:function(){
            ...
            html += '<div class="region region-footer"><div class="block block-menu contextual-links-region first odd" id="block-menu-menu-footer-menu" style="margin-top:35px;">';
