...
<ul>
 ...
 <li>locationphone</li>
  ...
  <li>sessiondetails - It contains session information about the class. </li>
</ul>
...
<strong>Input Parameters:</strong> Following will be the list of Optional/Mandatory parameters to make this api call. </p>
<h3>Optional Params </h3>
<ul><li>regstatuschk - Provide the registration status code to filter the results. (If more than one, use comma(,) as delimeter)</li></ul>
<h3>Required params  </h3>
<ul>
<li>userid</li>
...
<li>  surveystatus</li>
<li>  islaunchable</li> 
<li>  launchdata</li>  - Contains data which requires for content launch with ^^separator.
</ul>
<div class="toc" id="toc">
<div class="toc-title"></div>
<div class="toc-list">
