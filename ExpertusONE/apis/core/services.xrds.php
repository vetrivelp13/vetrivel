...
<XRDS xmlns="xri://$xrds">
	...
	<Service>
	    ...
	    <URI>http://<?php echo $server; ?>/apis/core/oauth/request_token</URI>
	</Service>
	<Service>
	    <Type>http://oauth.net/core/1.0/endpoint/authorize</Type>
	    <Type>http://oauth.net/core/1.0/parameters/uri-query</Type>
	    <URI>http://<?php echo $server; ?>/apis/core/oauth/authorize</URI>
	</Service>
	<Service>
	    ...
	    <Type>http://oauth.net/core/1.0/signature/HMAC-SHA1</Type>
	    <Type>http://oauth.net/core/1.0/signature/PLAINTEXT</Type>
	    <URI>http://<?php echo $server; ?>/apis/core/oauth/access_token</URI>
	</Service>
    </XRD>
</XRDS>
