...
class ClamAVScanner extends AntivirusExecutableScanner {
  ...
  public function scan($file, $options = array(), $debug = FALSE) {
    ...
    return $ret; // Expertus: this line replaces the below commented code
    /* Expertus:  Code commented since drupal_set_message() is causing a system error and replaced with the above line
    switch ($ret) {
