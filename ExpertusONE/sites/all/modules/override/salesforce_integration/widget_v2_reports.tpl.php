...
$block_rendered_reports= drupal_render($variables['widgetarray'][0]);
 ?>
<div style="display:none;" id="reports_searchtext"></div><!--  search box -->
									      ...
									      <div class="section"> <!-- start section-->
											<div class="region region-highlight"> <!-- start region --> 
												   <!-- start my enrollment block-->
												       <?php print $block_rendered_reports; ?>
